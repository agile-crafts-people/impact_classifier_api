...
LABEL org.opencontainers.image.source="https://github.com/agile-crafts-people/impact_classifier_api"
...
CMD exec python -m gunicorn --bind 0.0.0.0:9102 src.server:app