...
class TestAppConfiguration(unittest.TestCase):
    ...
    def test_ratios_routes_registered(self):
        """Test that /api/ratios routes are registered."""
    ...
    def test_all_blueprints_registered(self):
        ...
        self.assertIn('ratios_routes', blueprint_names)
    ...
    def test_url_map_contains_expected_routes(self):
        ...
        self.assertTrue(any('/api/ratios' in rule for rule in rules))
