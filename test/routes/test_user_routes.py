"""
Unit tests for user routes (consume-style, read-only).
"""
import unittest
...
class TestuserRoutes(unittest.TestCase):
    ...
    def test_get_users_success(
        ...
        """Test GET /api/user for successful response."""
    ...
    @patch("src.routes.user_routes.create_flask_token")
    def test_get_users_unauthorized(self, mock_create_token):
        """Test GET /api/user when token is invalid."""
