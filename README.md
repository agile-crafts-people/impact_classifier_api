# Creators Dashboard — Classifier API
...
## run api server in dev mode - captures command line, serves API at localhost:9100
pipenv run dev

## run E2E tests (assumes running API at localhost:9100)
pipenv run e2e
...
curl http://localhost:9100/api/config \
